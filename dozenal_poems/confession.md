...
*A Dozenal of envy — the form that carries prayer can also carry the knife you've been hiding in your smile.*
...
| IV | L6 (external comparison) → L7 (internalized shadow) ✓ |
| V | "Jealous is the word for" → "I am the word for it" — the speaker stops describing the emotion and *becomes* it ✓ |
| VI | won → Winning · love → Loving · jealous → Jealous (circular) ✓ |
