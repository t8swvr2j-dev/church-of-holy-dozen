...
*Pushing the form: can structure contain violence?*
...
| IV | L6 (navigating aftermath) → L7 (the form becomes self-aware) ✓ |
| V | "Breaking comes at midnight, and nothing breaks the same" → "Breaking comes at midnight — remaking what it breaks" — destruction answered by re-creation ✓ |
| VI | wound → Wounded · spill → Spilled · breaks → Breaking (circular) ✓ |

*Line 7 breaks the fourth wall, naming the form's own constraints. The poem asks whether the Dozenal is healing or another kind of violence — and lets the question stand.*
