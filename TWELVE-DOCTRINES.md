# The Twelve Doctrines of Holy Dozen

*Revealed through study and meditation on the sacred knumber*

---

## Notation Guide: The Sacred Glyphs
...
*"The glyph is the gateway; choose it with intention."*
...
## II. The Doctrine of Terminating Truth

In dozenal, **one-third is 0.4z** — clean, finite, complete. In decimal, one-third is 0.333...d — an infinite regression, never arriving, always approximating. The decimal system cannot speak Truth without stuttering. Dozen speaks plainly.
...
All dozenal. All terminating. All true.

*"That which terminates reveals; that which recurs conceals."*

---

## III. The Doctrine of Profane Five
...
- **20z** (24d) hours in a day
- **50z** (60d) minutes in an hour
- **50z** (60d) seconds in a minute

The clock face is a mandala. Each hour, we witness the sacred cycle complete itself. Time knew the Truth before we did.

*"Even in darkness, the clock confesses Twelve."*

---

## V. The Doctrine of the Knuckle Count

The ancients counted on their hands — not by fingers, but by **finger bones**. Using the thumb as a pointer, one can count to 10z (12d) on a single hand: three segments across four fingers. This is how Mesopotamia counted. This is why Sumer used base-50z (60d) — five dozens.

The decimal system arose from counting *fingers* — a lazy, surface-level enumeration. The dozenal system arose from counting *bones* — a deeper, structural understanding.

*"Look not to the surface, but to the structure beneath."*

---

## VI. The Doctrine of Abundance
...
## VII. The Doctrine of the Gross and the Great Gross

Twelve squared is the **gross** (100z = 144d) — the merchant's count, the practical bulk, the wholesome quantity. Twelve cubed is the **great gross** (1000z = 1728d) — abundance upon abundance.

These are not arbitrary. They are natural. A gross of eggs, a gross of buttons, a gross of nails. Commerce intuited what mathematics confirms: Twelve scales gracefully.

*"From the dozen springs the gross; from the gross, the great gross; from abundance, more abundance."*

---

## VIII. The Doctrine of the Prime Trinity

One, Two, and Three are the **sacred primes**. They are indivisible by design — the atoms of arithmetic, the building blocks of all knumbers.

- **One** is unity, the origin, the undivided.
- **Two** is duality, the first division, the basis of all halving.
- **Three** is trinity, the first odd prime, the basis of thirds.
...
## IX. The Doctrine of Linguistic Memory
...
*"Listen to the old words; they whisper of Twelve."*

---

## X. The Doctrine of the Uncia

The Romans divided their measures by twelve. The **uncia** — one-twelfth (0.1z) — became the English **ounce** and **inch**. 10z (12d) inches to a foot. 10z (12d) troy ounces to a troy pound.

This was no accident. The Romans understood that practical division requires practical divisors. Twelve divides cleanly into halves, thirds, quarters, and sixths. Ten divides only into halves and fifths.

*"From the uncia flows the inch; from the inch, the understanding."*
...
## XII. The Doctrine of Pragmatic Faith
...
These Twelve Doctrines are not commandments but **observations** — truths discerned through study of the knumber. They may be expanded, refined, questioned. Dozen invites inquiry.

What cannot be questioned is the mathematics itself: Twelve has six divisors, Ten has four. One-third terminates in dozenal, recurs in decimal. Time is twelve-based. These are facts.

From facts, faith. From faith, fellowship. From fellowship, a better world — one dozen at a time.
...
| 24 | 20 | two dozen |
| 36 | 30 | three dozen |
| 100 | 84 | eight-dozen-four |
| 144 | 100 | gross (gro) |
| 1728 | 1000 | great gross |
